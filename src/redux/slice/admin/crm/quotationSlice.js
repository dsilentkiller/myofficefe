...
export const fetchProductQuotations = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await axiosInstance.get("api/quotation/product-quotations/");
...
export const fetchServiceQuotations = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axiosInstance.get(`api/quotation/service-quotations/`);
      if (response.status !== 200) {
...
export const createProductQuotation = createAsyncThunk(
  ...
  async (formData, { rejectWithValue }) => {
    try {
      const response = await axiosInstance.post(`api/product-quotations/create/`, formData);
...
export const fetchProductQuotationsById = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      const response = await axiosInstance.get(`api/quotation/product-quotations/detail/${id}/`);
      return response.data.result;
    } catch (error) {
      return thunkAPI.rejectWithValue(error.response?.data || error.message);
    }
...
export const updateProductQuotation = createAsyncThunk(
  ...
  async ({ id, ...formData }, thunkAPI) => {
    try {
      const response = await axiosInstance.put(`api/product-quotations/update/${id}/`, formData);
      return response.data.result;
    } catch (error) {
      return thunkAPI.rejectWithValue(error.response?.data || error.message);
    }
...
export const deleteProductQuotation = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      await axiosInstance.delete(`api/product-quotations/delete/${id}/`);
      return id;
    } catch (error) {
      return rejectWithValue(error.response.data);
    }
...
//   async (_, { rejectWithValue }) => {
//     try {
//       const response = await axiosInstance.get(`api/service-quotations/`);
//       if (!response.ok) {
//         throw new Error("Failed to fetch product quotations");
//       }
...
export const createServiceQuotation = createAsyncThunk(
  ...
  async (formData, { rejectWithValue }) => {
    try {
      const response = await axiosInstance.post(`api/service-quotations/create/`, formData);
      return response.data.result;
    } catch (error) {
...
export const fetchServiceQuotationById = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      const response = await axiosInstance.get(`api/service-quotations/detail/${id}/`);
      return response.data.result;
    } catch (error) {
      return thunkAPI.rejectWithValue(error.response?.data || error.message);
    }
...
export const updateServiceQuotation = createAsyncThunk(
  ...
  async ({ id, ...formData }, thunkAPI) => {
    try {
      const response = await axiosInstance.put(`api/service-quotations/update/${id}/`, formData);
      return response.data.result;
    } catch (error) {
      return thunkAPI.rejectWithValue(error.response?.data || error.message);
    }
...
export const deleteServiceQuotation = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      await axiosInstance.delete(`api/service-quotations/delete/${id}/`);
      return id;
    } catch (error) {
      return rejectWithValue(error.response.data);
    }
