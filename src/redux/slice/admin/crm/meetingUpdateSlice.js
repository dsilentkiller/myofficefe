...
// API base URL
const BASE_URL = "api/meeting-update/";
...
export const searchMeetingUpdate = createAsyncThunk(
  ...
  async (searchTerm, thunkAPI) => {
    try {
      const response = await axiosInstance.get(`${BASE_URL}/?search=${searchTerm}`);
...
export const fetchMeetingUpdate = createAsyncThunk(
  ...
  async (eventId, thunkAPI) => {
    try {
      const response = await axiosInstance.get(`api/meeting-update/list/${eventId}/`);
      // , {
  ...
  async ({ eventId, formData }, { rejectWithValue }) => {
    try {
      ...
      const response = await axiosInstance.post(
        `api/meeting-update/create/${eventId}/`,
        formData
      );
...
export const updateMeetingUpdate = createAsyncThunk(
  ...
  async ({ id, data }, thunkAPI) => {
    try {
      const response = await axiosInstance.put(`${BASE_URL}/update/${id}/`, data);
      return response.data.result;
    } catch (error) {
...
//       `api/meeting-update/?search=${searchTerm}`
//     );
//     return response.data.result.data;
//   }
// );
