...
export const searchAttendee = createAsyncThunk(
  ...
  async (searchTerm) => {
    const response = await axiosInstance.get(
      `api/event/attendee/?search=${searchTerm}`
    );
...
export const fetchAttendees = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await axiosInstance.get("api/event/attendee/");
...
export const deleteAttendee = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      ...
      await axiosInstance.delete(`     api/event/attendee/delete/${id}/`);
