...
const EnquiryForm = () => {
  ...
  // Update filteredDistricts whenever selectedProvince changes
  useEffect(() => {
    if (selectedProvince) {
  ...
  useEffect(() => {
    if (formData.district) {
      const newFilteredMunicipalities = municipalities.filter(
        (municipality) => municipality.district_id === formData.district
      );
      setFilteredMunicipalities(newFilteredMunicipalities);
    } else {
  ...
  const handleProvinceChange = (e) => {
    ...
    dispatch(fetchDistricts(selectedProvince)); // Fetch districts for the selected province
  };
  ...
  const handleDistrictChange = (e) => {
    ...
    dispatch(fetchMunicipalities(selectedDistrict)); // Fetch municipalities for the selected district
  };
