...
import { AppBar, Toolbar, IconButton, Button, InputBase, Box, Divider } from "@mui/material";
...
const DefaultHeader = () => {
  ...
  return (
    <div>
       <nav nav className="main-header navbar navbar-expand navbar-white navbar-light">
