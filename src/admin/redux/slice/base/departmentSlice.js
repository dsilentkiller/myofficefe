...
//         "http://127.0.0.1:8000/api/setup/department/create/",
//         departmentData
//       );
//       return response.data.result.data; // Adjust this based on your actual API response structure
//     } catch (error) {
...
export const fetchDepartmentById = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      const response = await axios.get(
        `http://127.0.0.1:8000/api/setup/department/${id}/`
      );
      return response.data.result.data; // Adjust this based on your actual API response structure
    } catch (error) {
  ...
  async ({ id, name }, thunkAPI) => {
    try {
      const response = await axios.put(
        `http://127.0.0.1:8000/api/setup/department/update/${id}/`,
        { name }
      );
      return response.data.result.data;
    } catch (error) {
...
export const deleteDepartment = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      ...
      await axios.delete(
        `http://127.0.0.1:8000/api/setup/department/delete/${id}/`
      );
