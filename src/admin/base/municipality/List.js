...
const MunicipalityList = () => {
  ...
  // Function to fetch the list of municipalities from the backend
                            ...
                            {municipalities.length > 0 ? (
                              municipalities.map((municipality) => (
                                <tr key={municipality.id}>
                                  ...
                                  <td>
                                    <a
                                      href={`/municipality/update/${municipality.id}`}
                                    >
                                      Edit
                                    </a>
                                    |
                                    <a
                                      href={`/municipality/detail/${municipality.id}`}
                                    >
                                      View
                                    </a>
                                    |
                                    <a
                                      href={`/municipality/delete/${municipality.id}`}
                                    >
                                      Delete
                                    </a>
                                  </td>
                              ...
                              <tr>
                                <td colSpan="8">No municipalitys found</td>
                              </tr>
                            )}
                          </tbody>
                        </table>
