...
import { deleteFollow } from "../../../../redux/slice/admin/crm/followSlice";

const FollowDelete = ({ id, onClose }) => {
  ...
  const handleDelete = () => {
    dispatch(deleteFollow(id))
      ...
      .then(() => {
        ...
        navigate("/dashboard/crm/follow/"); // Adjust this route as needed
      })
      .catch((error) => {
        toast.error(`Failed to delete follow: ${error.message}`);
      })
      .finally(() => {
