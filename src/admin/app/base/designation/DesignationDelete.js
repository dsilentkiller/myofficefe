...
import { deleteDesignation } from "../../../../redux/slice/admin/base/designationSlice";

const DesignationDelete = ({ id, onClose }) => {
  ...
  const handleDelete = () => {
    dispatch(deleteDesignation(id))
      ...
      .then(() => {
        ...
        navigate("/dashboard/setup/designation"); // Adjust this route as needed
      })
      .catch((error) => {
